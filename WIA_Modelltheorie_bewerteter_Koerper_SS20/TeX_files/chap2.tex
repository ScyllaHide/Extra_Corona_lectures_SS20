...
\begin{definition}\proplbl{def_2_2_8}
	...
	\end{itemize}
\end{definition}
%TODO Add literatur remark here! Marker theorem 1.1.10 and add reference 3.2 here!}
\begin{remark}
...
\begin{remark}\proplbl{rem_2_2_10}
	...
	\end{align*}
\end{remark}
% TODO How to proof this? Or is it obvious?
...
\end{remark}
%TODO This also needs a small proof here, but for me its not clear!
...
\begin{proof}[\propref{rem_2_2_13}, Marker, Lemma 2.3.3]
	\begin{enumerate}
		\item \begin{itemize}
			...
			%TODO Still to finish, maybe think about it!
		\end{itemize}
